...
export default class GetSubjectScheduling extends Component {
    constructor(props) {
        super(props);
        this.state = {
            show: false,
        ...
        return (
            ...
            <tbody className="text-left h-16 ">
                <tr className="h-16 border-b-2 border-gray-200 ">
                    ...
                    <td>{this.props.nameSubject}</td>
                    <td className="">{this.props.idSubject}</td>
                    <td className="">{this.props.nameStudent}</td>
                    <td className="">{this.props.nameMentor}</td>
