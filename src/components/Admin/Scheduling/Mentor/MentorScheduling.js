...
import GetMentorScheduling from "./GetMentorScheduling";


    export default class MentorScheduling extends Component {
        render() {
            var appointments = [
                {
                    key: 1,
                ...
                <table className="table-auto w-full   text-left">
                                <thead className=" h-10   bg-gray-200  ">
                                    <tr className=" ">
                                        ...
                                        <th className="w-72  ">Subject</th>
                                        <th className="w-64">Student</th>
